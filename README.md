...
| 🏷️ **Category**                          | 📦 **Name**             | 🛠️ **Type**  | 📝 **Description**                                    |
| ----------------------------------------- | ----------------------- | ------------- | ----------------------------------------------------- |
| **✨ Enhanced Vanilla Experience**         | Jade                    | Mod           | Displays contextual block and entity information 🪷   |
...
| **⚡ Quality-of-Life Improvements**        | AppleSkin               | Mod           | Shows hunger and saturation values 🍎                 |
...
| **🚀 Visual & Performance Optimizations** | Sodium                  | Mod           | Major rendering performance improvements 🖥️          |
